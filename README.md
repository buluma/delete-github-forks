...
```sh
$ while read repo; do curl -X DELETE -H "Authorization: token Your_TOKEN" "https://api.github.com/repos/$repo"; done <  repo_list_deleting.txt # Reads from repos.json and deletes the repos inside it.
```
